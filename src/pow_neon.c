...
static void transform128(uint64x2_t *lmid, uint64x2_t *hmid)
{
    int t1, t2;
...
static int incr128(uint64x2_t *mid_low, uint64x2_t *mid_high)
{
    int i;
...
static void seri128(uint64x2_t *low, uint64x2_t *high, int n, int8_t *r)
{
    int index = 0;
...
static int check128(uint64x2_t *l, uint64x2_t *h, int m)
{
...
static int64_t loop128(uint64x2_t *lmid,
                       uint64x2_t *hmid,
                       int m,
                       int8_t *nonce,
                       int id)
...
static void para128(int8_t in[], uint64x2_t l[], uint64x2_t h[])
{
...
static void incrN128(int n, uint64x2_t *mid_low, uint64x2_t *mid_high)
{
    for (int j = 0; j < n; j++) {
